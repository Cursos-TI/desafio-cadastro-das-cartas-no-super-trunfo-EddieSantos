...
int main() {
    ...
    densidade_pop1 = (float)populacao1 / area1; // Aqui foi feito a conversão explicita para float

    // Calculando o PIB per capita da carta 1
    pib_per_capita1 = pib1 / (float)populacao1; // Aqui foi feito a conversão explicita para float
    ...
    densidade_pop2 = (float)populacao2 / area2; // Aqui foi feito a conversão explicita para float

    // Calculando o PIB per capita da carta 2
    pib_per_capita2 = pib2 / (float)populacao2; // Aqui foi feito a conversão explicita para float
